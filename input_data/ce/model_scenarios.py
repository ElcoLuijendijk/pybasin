...
#basal_heat_flow_scenarios = [70.0e-3]

basal_heat_flow_scenarios = [50e-3]
try:
    import cebs 
    import sys    
    ...
    if len(sys.argv) > 1:
        ...
        well_hf = wells       
    # takes basal heat flow from data, if existent
    basal_heat_flow = cebs.basal_heat_flow_scenarios(well_hf,basal_heat_flow_scenarios)
except:
    basal_heat_flow = basal_heat_flow_scenarios
basal_heat_flow_scenarios = basal_heat_flow
