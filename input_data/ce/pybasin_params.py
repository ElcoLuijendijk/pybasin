...
input_dir = 'input_data/ce'
output_dir = 'model_output/ce'
...
try: # runs only when well for compare exist
    import cebs
    simulate_AFT = cebs.simulate_AFT(simulate_AFT)
except:
    pass
...
try: # makes figure only when well for compare exist
    import cebs
    make_model_data_fig = cebs.make_model_data_fig(make_model_data_fig,simulate_VR,simulate_AFT,simulate_AHe)
except:
    pass
...
heatflow_history = np.array([65.0, 65.0, 65.0, 65.0]) * 1e-3
