...
# lsit of wells, use ['all'] to run all wells that are contained in the well_startigraphy.csv file

wells = ['all']
#wells = ['Well9882']

# start well, in case where wells=['all'] you can select a starting well from the list of wells
# useful for resuming a long model run list halfway
# set to None if you want to run the entire list of wells
start_well = 'Well9882'
