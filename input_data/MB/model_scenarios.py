...
# Rigi wells:
# note, well RV10b deleted, only one AHe datapoint and no AFT data...
wells = ['Huenenberg',
         'MRP025', 'MRP170', 'MRP172', 'MRP174',
         'RH10', 'RH12', 'RH15', 'RH17', 'RH20', 'RH23', 'RH30a', 'RH30b',
         'RH35', 'RH40', 'RH45', 'RH50', 'RH60c', 'RH65', 'RH70',
         'RV05', 'RV15', 'RV20', 'RV25', 'RV30c',
         'Weggis', 'Entlebuch']


#wells = ['MRP172', 'MRP174', 'RH12', 'RH50', 'RH65']
#wells = ['RV15', 'RV20', 'RV25', 'RV30c',
#         'Weggis', 'Entlebuch']
...
#basal_heat_flow_scenarios = [70.0 * 1e-3]
...
exhumation_magnitudes = np.arange(0., 5000, 250)
...
exhumation_duration_factors = [0.2, 0.3, 0.4, 0.5]
#exhumation_segment_factors = [0.5]
#exhumation_duration_factors = [0.5]
